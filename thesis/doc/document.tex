...
\begin{document}
  ...
  \begin{abstract}
    ...
    Nuestra formulación, que es un problema lineal entero mixto (MILP o MIP, en inglés), es resuelta utilizando solvers MIP conocidos en la academia. Realizamos experimentos numéricos sobre un caso utilizado en la literatura y por último sobre un caso real: la ciudad de Montevideo.
  \end{abstract}
