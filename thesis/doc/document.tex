...
\begin{document}
  ...
  \begin{align}
    f(W) =\; & max \sum_{j \in J} P_j y_j             & \label{eq:fkv2eq1}\\
             ...
             & \;\;\; \sum_{j \in J} w^{aux}_j = W    & \forall j \in J \label{eq:activatewaux} \\
             & \;\;\; y_i \in {0,1}                   & \\
