...
\begin{document}
 ...
 \subsection{Formulación matemática de dos niveles}
  ...
  Presentamos dos soluciones: la S utilizando la variante de un único objetivo y la SM utilizando cualquiera de las variantes multiobjetivo (ecuaciones (\ref{eq:multipleobj1}) ó (\ref{eq:multipleobj2})).
