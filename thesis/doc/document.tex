...
\begin{document}
  ...
  \begin{sidewaystable}
    ...
    \begin{tabular}{ccccccc}
        ...
        0.4 & 20 & lineal & 52 & 261692.07657 & Si & 0.03 \\
        ...
        1.6 & 20 & lineal & 127 & 265228.53262 & Si & 0.02 \\
        3.2 & 5 & lineal & 153 & 267535 & Si & 0.05 \\
        3.2 & 20 & lineal & 178 & 7385 & No &  \\
        \bottomrule
    \end{tabular}
      \caption{De las 20 instancias, 13 no terminaron en 72 horas de ejecución, sin embargo solo 2 quedaron con un gap relativo alto o indefinido.} \label{table:sensibilityresults}
  \end{sidewaystable}

  Las instancias fueron ejecutadas con el solver CBC con un tiempo máximo de ejecución de 72 horas. Los resultados completos se encuentran en la tabla (\ref{table:sensibilityresults}).
