...
\begin{document}
  ...
  Se utilizó la ciudad de Sioux-Falls como grafo base, dada su fama en la academia, y se generaron pares origen destino y valores de $P$ y $Q$ aleatorios. De esta manera se generaron y probaron 1000 instancias para cada uno de las cuatro variantes de modelos. Ademas de los chequeos sobre las soluciones, es de interés comparar los valores de demand transferida total, presupuesto utilizado y tiempo de ejecución.
