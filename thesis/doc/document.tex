...
\begin{document}
  ...
  \begin{figure}[h!]
    ...
    \includegraphics[width=12cm]{../resources/sioux_falls_demand.png}
      \caption{Visualización de la distribución del pares origen y destino junto a su valor de demanda representado por el tamaño de los círculos.}
    \label{fig:sensibilitybudgetusage}
  \end{figure}
