...
\begin{document}
  ...
  La formulación en realidad asume que las funciones $f_k$ son estrictamente decrecientes. Notaremos que si las funciones son solo decrecientes, entonces puede haber valores de costos de caminos más cortos que no tienen incentivo a decrecer. Por la forma en que adaptamos estas funciones al método de programación lineal no les vamos a imponer esta restricción, sino que analizaremos variantes de esta formulación como multiobjetivo o multiobjetivo lexicográfico.
