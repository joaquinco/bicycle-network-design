...
\begin{document}
  ...
  % TODO: agregar comentario de la funcion logística del trabajo Modeling Transport de Ortuzar
  Se investigarán también algunas alternativas a $f$: la función logística inversa, una con concavidad positiva y otra con concavidad negativa en el intervalo $[m, 1]$.
