...
\begin{document}
  ...
  De las ejecuciones, cuyo resumen se encuentra en la tabla (TODO: ref tabla se muestra la comparación agregada de las ejecuciones.) se pudo comprobar que el modelo con la primera formulación de $f_k$ tuvieron tiempo de ejecución mucho mayor que aquellos con la segunda version.
