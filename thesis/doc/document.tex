...
\begin{document}
  ...
  La dificultad de las formulaciones binivel es, ademas de la naturaleza combinatoria de nuestro problema, que no existen maneras de resolverlos directamente con un solver por lo que luego analizaremos maneras de reformularlo y formulaciones alternativas.
