...
\begin{document}
  ...
  Revisión de los principales artículos sobre diseño de redes de ciclovías, notar que ninguno aborda el problema de esta tesis. Incluir en la revisión, otros artículos sobre maximización de la atracción de la demanda en diseño de redes de transporte. (para las dos partes anteriores podés recurrir al documento de Bayá
et al, escribiéndolo con tus propias palabras).

  \subsection*{Este trabajo}
