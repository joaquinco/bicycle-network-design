...
\begin{document}
  ...
  La planificación de construcción de ciclovías al igual que la transferencia de demanda, o lo que es lo mismo cubrimiento de la demanda, entre modos de transporte son problemas que han sido tratados de diferentes puntos de vista en la literatura. Diversos trabajos han trabajado sobre modelos que optimizan la demanda cubierta por cierto medio de transporte en función del costo de usuario. Este es el caso en (\ref{garcia2005}), (\ref{laporte2007}) y (\ref{marin2007}) donde el objetivo es maximizar la demanda cubierta para la planificación de la red de metro y trenes. El modelado de este comportamiento se hizo como {\it all-or-nothing}, de manera que si el costo usuario de ir de un origen a un destino es menor a un valor umbral predefinido entonces se considera que la demanda está cubierta. En nuestro trabajo tomamos un enfoque mas complejo al modelar este comportamiento potencialmente como un cubrimiento paulatino lo que permite modelar la variabilidad de las decisiones humanas como se menciona mas adelante.
