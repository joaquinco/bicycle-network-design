...
\begin{document}
 ...
 \subsection{Hipótesis}
  ...
  A futuro, se puede seguir trabajando sobre esta formulación para que considere otros aspectos tratados en otros trabajos como discontinuidades en los tipos de infraestructura \cite{baya2021}, integrar el concepto de camino seguro, de \cite{lim2021}, y permitir distinguir qué tipos de infraestructura se puede construir en cada arco de la red.
