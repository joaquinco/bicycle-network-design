...
\begin{document}
  ...
  \begin{itemize}
    \item{El tiempo de viaje en todo arco de la red es independiente del flujo sobre el mismo. En general el modelado del tráfico en bicicleta no considera capacidades ni congestión por los valores de demanda y flujo que se manejan \cite{Sheffi1985}. La literatura sobre redes de ciclovía estudiada también asume esta hipótesis.
      % TODO: mechar paper Vedel2017 sobre encuesta de ruatas de ciclistas en zonas congestionadas: Como excepción esta el trabajo \cite{Vedel2017}.
    }
