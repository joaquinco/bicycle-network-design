...
\begin{document}
  ...
  Para solucionar la diferencia en demanda transferida se agregó un parámetro que disminuye el efecto de las variables de resto $r$ en la función objetivo.

  % TODO: explicar calculo del parametro inf
  %       correr comparacion de nuevo con los modelos v1, v2 y v5
  %       tabla de ejecuciones y graficas comparativas
  %       sobre las mismas instancias? sobre nuevas?
