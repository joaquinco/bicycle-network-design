...
\begin{document}
  ...
  Finalmente se analizará en mayor profundidad la forma de especificar la función $f$ y los puntos de quiebre. En particular, se alternará entre 5 y 10 puntos de quiebre, se definiran los puntos de dos formas: equidistantes en el dominio y equidistantes en el codominio y se analizarán las cuatro funciones de la figura (TODO: figura con formas de f).
