...
\begin{document}
  ...
  De manera general, en la literatura de optimización sobre redes podemos encontrar problemas que pueden ser aplicables a nuestro caso, tomados de \cite{Crainic2021}. Los siguientes tipos de problemas son aplicables al diseño de redes, con sus nombres originales:
  ...
  \begin{enumerate}
    ...
    \item{{\it Bilevel}: Este enfoque permite modelar situaciones en las que hay dos entidades jerárquicas potencialmente no alineadas en sus objetivos. El primer nivel optimiza anticipando las decisiones del segundo nivel cuyo objetivo y/o restricciones dependen de las decisiones del primero. Es relevante en el diseño de redes cuando el planificador de las {\it facilities} no tiene control sobre el comportamiento del flujo de {\it commodities}.}
