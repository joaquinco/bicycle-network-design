...
\begin{document}
 ...
 \subsection{Hipótesis}
  ...
  A futuro, se puede seguir trabajando sobre esta formulación para que considere otros aspectos tratados en otros trabajos como discontinuidades en los tipos de infraestructura (\ref{baya2021}) e integrar el concepto de camino seguro, de (\ref{lim2021}).
  ...
  Respecto a los datos, en este trabajo estimamos y aproximamos muchos de los parámetros. Pensamos que puede ser interesante aplicar este problema con datos lo más realistas posibles. También puede ser interesante comparar los resultados obtenidos con soluciones actuales implementadas en ciudades con buenos niveles de servicio de bicicletas que tengan información histórica de su utilización.
