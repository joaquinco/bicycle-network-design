...
\begin{document}
  ...
  Se utilizó la ciudad de Sioux-Falls como grafo base, dada su fama en la academia, y se generaron pares origen-destino y valores de $P$ y $Q$ aleatorios. De esta manera se generaron y probaron 1000 instancias para cada uno de las cuatro variantes de lsa formulaciones. Ademas de los chequeos sobre las soluciones, es de interés comparar los valores de demand transferida total y tiempo de ejecución. Las ejecuciones se limitaron a un tiempo máximo de 24 horas, que para el tamaño de las instancias y objetivo de la ejecución parece razonable.

  De las ejecuciones se pudo comprobar que el modelo con la primera formulación de $f_k$ tuvieron tiempo de ejecución mucho mayor que aquellos con la segunda version. Ademas, las ejecuciones con la segunda version y sin variables de holgura obtuvo diferencias en los valores de demanda transferida respecto a los otros modelos.
  ...
  En la tabla TODO: ref tabla se muestra la comparación agregada de las ejecuciones.
