...
\begin{document}
  ...
  En la práctica, la mayoria de los estudios se enfocan en la transferencia de demanda, o {it modal shift}, entre diferentes modos de tranporte y sistemas de bicicletas compartidas. En este estudio no se hace diferencia entre sistemas compartidos y privados pero podemos tomar estos como punto de partida para estimar una funcion de transferencia de demanda. 
  ...
  \begin{description}
    ...
    \item[Puntos de quiebre]: Consideramos la función de transferencia de demanda 
        dos funciones para aproximar los valores P y Q en 10 puntos. Para P aproximamos la funcion lineal entre 1 y 0.7, es decir entre no mejorar el camino mas corto y mejorarlo en un 30\%. Para Q aproximamos la función: TODO: que funcion de modal shift usar? ver related work.
  ...
  \begin{enumerate}
    \item{\label{heartrisksuy} Investigación sobre factores de riesgo cardiovascular en Uruguay, 2004.}
    \item{\label{mspphisicalactivityguid} ¡A MOVERSE! Guia de actividad física, MSP.}
    \item{\label{mspsurveyriskfactors} Encuesta Nacional de Factores de Riesgo de Enfermedades no transmisibles, MSP.}
