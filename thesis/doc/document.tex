...
\begin{document}
  ...
  \begin{figure}[h!]
    ...
    \label{figruntimecomparison}
  \end{figure}

  \begin{figure}[h!]
    \centering
    \includegraphics[width=12cm]{../resources/run_time_comparsion_by_quintile.png}
      \caption{Comparativa de el tiempo de ejecución de todas las versiones en tiempo promedio por quintil. El promedio de las ejecuciones es en el tiempo promedio acumulado.}
    \label{figruntimecomparison}
  \end{figure}
