...
\begin{document}
 ...
 \subsection{Hipótesis}
  ...
  Respecto a los datos, en este trabajo estimamos y aproximamos muchos de los parámetros. Pensamos que puede ser interesante aplicar este problema con datos más realistas. Luego, contrastar los resultados obtenidos con soluciones actuales implementadas en ciudades con buenos niveles de servicio de bicicletas que tengan información histórica de su utilización de manera de validar el modelo.
