...
\begin{document}
  ...
  El objetivo es quitar la multiplicación entre $x_{ek}$ e $y_{ei}$. Se propone la formulación siguiente del problema de segundo nivel.
  ...
  \begin{align}
    ...
    \text{s.t.}\; & w_k = \sum_{e \in E} \sum_{k \in OD} C_{ei} x_{ek}                               & \forall k \in OD \label{eq:shortestpathfinal} \\
                  ...
                  & w_k \geq 0, y_{ei} \in \{ 0, 1\}, z_{kj} \in \{ 0, 1\}                           & \nonumber \\
