...
\begin{document}
  \begin{titlepage}
    \centering
    \includegraphics[width=6cm]{../resources/universidad-de-la-republica-uruguay.jpg} \\
    \vspace{1cm}
    \huge
 ...
 \begin{titlepage}
    ...
    \large
    Programa de no se que \\
    \vspace{2cm}
    \textbf{Directores de tesis:} Dr. Antonio Mauttone, Dr. Franco Robledo \\
    \textbf{Director académico:} Dr. Franco Robledo
    \vfill
    Montevideo, Uruguay \\
    Julio 2022
 \end{titlepage}
