...
\begin{document}
 ...
 \subsection{Hipótesis}
  ...
  Si observamos los datos de demanda transferida y costo de camino más corto, figura (\ref{fig:sensibilitybyodpair_11_12_13}), vemos que TODO: terminar.
  ...
  \begin{figure}[h!]
    ...
    \caption{Demanda transferia y costo del camino más corto para los pares origen-destino para los cuales hubo demanda transferida.}
