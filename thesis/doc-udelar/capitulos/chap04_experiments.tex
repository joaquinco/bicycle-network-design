...
\begin{figure}[h!]
  \centering
  \includegraphics[width=6.5cm]{../resources/montevideo_full.png}
  \includegraphics[width=6.5cm]{../resources/montevideo_simple.png}
...
Si comparamos las funciones de transferencia de demanda fijando el factor de presupuesto vemos que no hay diferencias significativas en términos de demanda transferida total, pares origen-destino afectados aunque la función lineal obtuvo levemente mejores resultados en términos de estos dos valores. No pudimos detectar diferencias claras en las decisiones respecto a las infrastructuras a construir ni el presupuesto asignado a cada tecnología, ver Tablas \ref{table:montevideobudgetusage} y \ref{table:montevideoinfracoverage}.
