...
Como análisis final comparamos la demanda transferida según nuestro modelo contra los datos de la encuesta de movilidadad \cite{Mauttone2017a}. El 2,6\% de un total de 4.201.184 viajes diarios se realiza en bicicleta, es decir 109.231 viajes. Por otro lado, en nuestro conjunto de datos de viajes tomados de \cite{Massobrio2020} tenemos un total de 6.568.837 viajes diarios que se reducen a 2.652.707 si consideramos únicamente los pares origen-destino que quedan a menos de 3 km en línea reacta. Ejecutamos una instancia con los mismos 600 pares origen-destino que en las instancias anteriores y un factor de presupuesto de 0,05 que equivale al factor de presupuesto de la red de ciclovías actual de la ciudad, ver Tabla \ref{table:cicloviasmontevideo}, dado su porcentaje sobre la red de calles y asumiendo que van en ambas direcciones. Luego calculamos los valores de demanda transferida total para los conjuntos completos de demanda asumiendo que las decisiones sobre infraestructura de ciclovía eran fijas según la instancia resuelta. Como resultado, ver Tabla \ref{table:montevideobikeusageresults}, vemos que los valores de utilización
...
\begin{table}[h!]
  ...
  \begin{tabular}{cccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Porcentaje de cada tipo de tecnología de ciclovía utilizado en Montevideo actualmente.}
...
\begin{table}[h!]
  ...
  \begin{tabular}{cccc}
    \toprule
      Demanda considerada                     & \# Viajes  & Utilización de la bicicleta (\%) \\
    \midrule
      \shortstack{Pares OD < 3 km \\ top 600} & 1.794.911 &              \\
      Pares OD < 3 km                         & 2.652.707 &              \\
      Todos                                   & 6.568.837 &              \\
